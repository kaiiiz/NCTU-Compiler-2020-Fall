...
ConstIntSymbolEntry::ConstIntSymbolEntry(std::string name, std::uint32_t level, std::shared_ptr<TypeBase> type, int64_t ival, const Location &loc)
...
ConstBoolSymbolEntry::ConstBoolSymbolEntry(std::string name, std::uint32_t level, std::shared_ptr<TypeBase> type, bool bval, const Location &loc)
...
ConstRealSymbolEntry::ConstRealSymbolEntry(std::string name, std::uint32_t level, std::shared_ptr<TypeBase> type, double rval, const Location &loc)
...
ConstStrSymbolEntry::ConstStrSymbolEntry(std::string name, std::uint32_t level, std::shared_ptr<TypeBase> type, std::string sval, const Location &loc)
